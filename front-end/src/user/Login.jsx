...
function Login() {
    ...
    const [details, setDetails] = useState({
        email: "rahul.k@dal.ca",
        password: "Password@11!",
        userSecurityAnswer: "abc12",
        isLoading: false,
        doRedirect: false
    });
            ...
            <div className="col-md-6 offset-sm-3 text-left">
                <form onSubmit={submitHandler}>
                    <div className="form-group">
                        <h3 className="h2 text-center text-success"> First
                            Factor Authentication </h3>
                        <hr className="dotted"/>
                    ...
                    <h3 className="h2 text-center text-success"> Second
                        Factor Authentication </h3>
                    <hr className="dotted"/>
                    <div className="form-group">
